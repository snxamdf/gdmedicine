...
public class WebMedicineMedControllerTests {
	...
	public void list() throws Exception {
		String url = "http://localhost:" + this.port + CTL.WEB_PATH + "/medicine/med/list";
		ResponseEntity<String> entity = new TestRestTemplate().getForEntity(url, String.class);
		assertEquals(HttpStatus.OK, entity.getStatusCode());
		assertTrue("Wrong body (title doesn't match):\n" + entity.getBody(), entity.getBody().contains("<title>药品管理表"));
	...
	public void save() throws Exception {
		...
		map.set("id", "root");
		String url = "http://localhost:" + this.port + CTL.WEB_PATH + "/medicine/med/save";
