...
public class BmsMedicineMedSalesControllerTests {
	...
	public void list() throws Exception {
		String url = "http://localhost:" + this.port + CTL.BMS_PATH + "/medicine/med/sales/list";
		ResponseEntity<String> entity = new TestRestTemplate().getForEntity(url, String.class);
		assertEquals(HttpStatus.OK, entity.getStatusCode());
		assertTrue("Wrong body (title doesn't match):\n" + entity.getBody(), entity.getBody().contains("<title>药品销售记录表"));
	...
	public void save() throws Exception {
		...
		map.set("id", "root");
		String url = "http://localhost:" + this.port + CTL.BMS_PATH + "/medicine/med/sales/save";
