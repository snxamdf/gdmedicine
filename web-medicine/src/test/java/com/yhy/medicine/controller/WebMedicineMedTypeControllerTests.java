...
public class WebMedicineMedTypeControllerTests {
	...
	public void list() throws Exception {
		String url = "http://localhost:" + this.port + CTL.WEB_PATH + "/medicine/med/type/list";
	...
	public void save() throws Exception {
		...
		map.set("id", "root");
		String url = "http://localhost:" + this.port + CTL.WEB_PATH + "/medicine/med/type/save";
