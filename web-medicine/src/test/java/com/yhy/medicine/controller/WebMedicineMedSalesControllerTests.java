...
public class WebMedicineMedSalesControllerTests {
	...
	public void list() throws Exception {
		String url = "http://localhost:" + this.port + CTL.WEB_PATH + "/medicine/med/sales/list";
	...
	public void save() throws Exception {
		...
		map.set("id", "root");
		String url = "http://localhost:" + this.port + CTL.WEB_PATH + "/medicine/med/sales/save";
