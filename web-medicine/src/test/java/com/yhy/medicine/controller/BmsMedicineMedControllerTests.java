...
public class BmsMedicineMedControllerTests {
	...
	public void list() throws Exception {
		String url = "http://localhost:" + this.port + CTL.BMS_PATH + "/medicine/med/list";
	...
	public void save() throws Exception {
		...
		map.set("id", "root");
		String url = "http://localhost:" + this.port + CTL.BMS_PATH + "/medicine/med/save";
