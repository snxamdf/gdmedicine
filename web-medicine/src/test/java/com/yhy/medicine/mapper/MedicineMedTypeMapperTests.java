...
public class MedicineMedTypeMapperTests {

	@Autowired
	private MedicineMedTypeMapper medicineMedTypeMapper;

	@Test
	public void findById() throws Exception {
		MedicineMedType medicineMedType = medicineMedTypeMapper.findById("1");
