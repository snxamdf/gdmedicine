...
<mapper namespace="${packageName}.${moduleId}.mapper.${className}Mapper">
	<resultMap id="baseResultMap" type="${packageName}.${moduleId}.domain.${className}" extends="com.yhy.core.mapper.BaseMapper.<#if '${tableExtend}' == 'tree'>tree<#else>sys</#if>ResultMap">
