...
(function($, window, undefined) {
	...
	/* ! 在最顶层页面添加样式文件 */
	/*
	 * (function(style){ if(!style) { var head =
	 * _doc.getElementsByTagName('head')[0], link = _doc.createElement('link');
	 * 
	 * link.href = _path + 'skins/' + _skin + '.css'; link.rel = 'stylesheet';
	 * link.id = 'lhgdialoglink'; head.insertBefore(link, head.firstChild); }
	...
	lhgdialog.fn = lhgdialog.prototype = {
		...
		_init : function(config) {
			...
			if (config.icon && !isIfr) {
				...
				DOM.icon[0].innerHTML = '<img src="' + ctl.statics + '/voucher/images/' + config.icon + '" class="ui_icon_bg"/>';
			} else
