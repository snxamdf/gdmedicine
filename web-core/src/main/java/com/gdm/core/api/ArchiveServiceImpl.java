...
import com.gdm.core.dto.Archive;
import com.gdm.core.dto.Result;
import com.gdm.core.exception.UploadException;
import com.gdm.core.utils.Identities;
...
public class ArchiveServiceImpl implements ArchiveService {
	...
	public Result<Archive> upload(MultipartFile file, String path) {
		...
		// 上传文件
		String formatPath = com.gdm.core.utils.Files.formatPath(path);
