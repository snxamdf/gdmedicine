 ...
 * 
 */
package com.yhy.core.conditional;
...
public class EnvCondition implements Condition {
	...
	public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
		boolean isBmsEnv = metadata.isAnnotated("com.yhy.core.annotation.BmsEnv");
		boolean isWebEnv = metadata.isAnnotated("com.yhy.core.annotation.WebEnv");
		boolean isWebappEnv = metadata.isAnnotated("com.yhy.core.annotation.WebappEnv");
		boolean isApisEnv = metadata.isAnnotated("com.yhy.core.annotation.ApisEnv");
